...
def pca(X, var=0.95):
    ...
    that transforms data into new coordinate system where the greatest variance
    ...
    Notes:
        ...
        - The input data X should be centered (mean = 0)
          before calling this function
        - The returned matrix W contains the principal
          component vectors as columns
