...
def batch_norm(Z, gamma, beta, epsilon):
    """
    Normalizes an unactivated output of a neural network using batch normaliz
    ...
    Args:
        ...
        gamma: numpy.ndarray of shape (1, n)
               contain the scales used for batch normaliz
        beta: numpy.ndarray of shape (1, n)
              contain the offsets used for batch normaliz
