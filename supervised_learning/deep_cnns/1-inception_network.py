...
def inception_network():
    ...
    conv1 = K.layers.Conv2D(64, (7, 7), strides=(2, 2), padding='same', activation='relu')(input_layer)
    max_pool1 = K.layers.MaxPooling2D((3, 3), strides=(2, 2), padding='same')(conv1)
    
    # Convolution before inception blocks
    conv2_reduce = K.layers.Conv2D(64, (1, 1), padding='same', activation='relu')(max_pool1)
    conv2 = K.layers.Conv2D(192, (3, 3), padding='same', activation='relu')(conv2_reduce)
    max_pool2 = K.layers.MaxPooling2D((3, 3), strides=(2, 2), padding='same')(conv2)
    ...
    max_pool3 = K.layers.MaxPooling2D((3, 3), strides=(2, 2), padding='same')(inception_3b)
    ...
    max_pool4 = K.layers.MaxPooling2D((3, 3), strides=(2, 2), padding='same')(inception_4e)
