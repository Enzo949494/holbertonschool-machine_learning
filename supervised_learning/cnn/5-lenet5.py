...
def lenet5(X):
    ...
    conv2 = K.layers.Conv2D(filters=16, kernel_size=(5,5), padding='valid',
                            activation='relu', kernel_initializer=he_init)(pool1)
    # MaxPooling 2x2, stride 2x2
    ...
    fc1 = K.layers.Dense(120, activation='relu', kernel_initializer=he_init)(flat)
    # Dense 84 neurones, ReLU
    fc2 = K.layers.Dense(84, activation='relu', kernel_initializer=he_init)(fc1)
    # Sortie 10 neurones, softmax
    out = K.layers.Dense(10, activation='softmax', kernel_initializer=he_init)(fc2)
